 ...
 * Every other capability - the named TOOLS, the web seam, the credential
 * backends - is a PLUGIN-provided service (`ctx.tools`, `ctx.web`, ...); the
 * core keeps no registry, no HTTP route and no listener of its own (operator
 * rule 2026-09-19).
 */
