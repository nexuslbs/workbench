/**
 * Web capability - CORE PROVIDER: a `node:http` server for the seam.
 *
 * It is the ONLY module of the core that touches a socket. It serves, in order:
 *
...
/**
 * Starts the core web server for a {@link Web} seam. The caller owns the
